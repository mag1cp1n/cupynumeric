...
struct ZipScatterImplBody<VariantKind::CPU, DIM, N> {
  TaskContext context;
...
/*static*/ void ZipScatterTask::cpu_variant(TaskContext context)
{
  zipscatter_template<VariantKind::CPU>(context);
}
...
static const auto cupynumeric_reg_task_ = []() -> char {
  ZipScatterTask::register_variants();
  return 0;
}();
